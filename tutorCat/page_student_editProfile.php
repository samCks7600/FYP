...
$result = mysqli_query(getDBconn(),"SELECT * FROM student WHERE Email='$tEmail';");
                ...
                while($row = mysqli_fetch_assoc($result)){
                    ...
                    if($icon == null){
//                       
                     $icon = '<img src="img/logo.jpg" alt="" class="rounded-circle" width="200" height="200">';
                    }else{
        ...
        $(document).ready(function() {
            ...
            $("#confirm_btn").click(function() {
                ...
                if ($("#oldPw").val() == '<?php echo $pw; ?>') {
                    ...
                    if ($("#newPw_input").val() == $("#conPw_input").val() && $("#newPw_input")!= null) {
                        let form = document.getElementById("form__submit");
                        form.submit();
                    ...
                    <div id="myProfile" class="col-md-8">
                        <div id="profile_block" class="card mb-3">
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-sm-3">
                                        <h6 class="mb-0">Progressive Subjects</h6>
                                    </div>
                                    <div class="col-sm-9 text-secondary">
                                        <input type="text" name="" class="form-control" value="<?php echo $subject; ?>" readonly="true">
