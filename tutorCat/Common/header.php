...
<body data-bs-spy="scroll" data-bs-target=".navbar" data-bs-offset="70">
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="page_viewTeachers.php">Tutor List</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="Common/notes/NotesList.php">NoteBook</a>
                    </li>
                    <li class="nav-item">
                        <?php
                        if (isset($_SESSION['StudentID']) || isset($_SESSION['TutorID'])) {
                            if ($_SESSION['account'] == 'Tutor') {
                                echo '<li class="nav-item"><a id="myPF" class="nav-link" href=' . $myPF . '>My Profile</a></li>';
                ...
                <div class="modal-body p-0">
                    ...
                    <div class="container-fluid">
                        <div class="row gy-4">
                            ...
                            <div class="col-lg-8">
                                <form class="p-lg-5 col-12 row g-3" action="signup.php" method="post">
                                    <div>
                                        <h1>Sign Up Now</h1>
                ...
                <div class="modal-body p-0">
                    ...
                    <div class="container-fluid">
                        <div class="row gy-4">
                            ...
                            <div class="col-lg-8">
                                <form class="p-lg-5 col-12 row g-3" action="login.php" method="post">
                                    <div>
                                        <h1>Login</h1>
                                        <p>
    ...
    <script src="js/showhidepw.js"></script>
